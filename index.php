...
<head>
    <meta charset="utf-8" />
    <title>Anees Ur Rahman - Portfolio</title>
                                            ...
                                            <div class="resume-card-body experience">
                                                <div class="resume-card-body-container second-font">
                                                    ...
                                                    <div class="resume-content">
														<h6 class="uppercase"><span>Web Developer - </span>Paigham TV</h6>
														<span class="date"><i class="fa fa-calendar-o"></i> 2018 - 2020</span>
														<p>Developed and Maintained the company website</p>
                                                    </div>
													<!-- Single Experience Ends -->
                                                    <span class="separator"></span>
													<!-- Single Experience Starts -->
                                                    <!-- <div class="resume-content">
														<h6 class="uppercase"><span>Web Developer - </span>Direct Visa</h6>
														<span class="date"><i class="fa fa-calendar-o"></i> 2017 - 2018</span>
														<p>Worked on website backend as a junior developer</p>
                                                    </div> -->
													<!-- Single Experience Ends -->
                                                    <!-- <span class="separator"></span> -->
													<!-- Single Experience Starts -->
                    ...
                    <div class="container">
                        ...
                        <div class="row contact section-padding">
                            ...
                            <div class="col s12 m5 l5 xl4 leftside">
                                ...
                                <span class="font-weight-400 second-font"><i class="fa fa-phone"></i> +966 581103259</span>
								<h6 class="font-weight-700 uppercase">Email</h6>
								<span class="font-weight-400 second-font"><i class="fa fa-envelope"></i> anees.coder2001@gmail.com</span>
								...
								<span class="font-weight-400 second-font"><i class="fa fa-home"></i>  Riyadh, Saudi Arabia</span><br>
								<!-- Contacts Ends -->
								<!-- Social Media Profiles Starts -->
                                <h6 class="font-weight-700 uppercase">Social Profiles</h6>
                                <div class="social">
                                    <ul class="list-inline social social-intro center-align p-none">
                                        <li class="twitter"><a href="https://twitter.com/kingkhan2388" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                        <li class="github"><a href="https://github.com/aneeskhan47" target="_blank"><i class="fa fa-github"></i></a></li>
                                    </ul>
                                </div>
            ...
            <div class="bl-panel-items" id="bl-panel-work-items">
                ...
                <div data-panel="panel-1">
                    <div class="row">
                        ...
                        <div class="col s12 l6 xl6 section-padding">
                            <h3 class="font-weight-700 uppercase">Quran Search Engine</h3>
                ...
                <div data-panel="panel-2">
                    <div class="row">
                        ...
                        <!-- Project Details Starts -->
                        <div class="col s12 l6 xl6 section-padding">
                            <h3 class="font-weight-700 uppercase">Hadith Ihyas</h3>
                            <ul class="project-details second-font">
                ...
                <div data-panel="panel-3">
                    <div class="row">
                        ...
                        <!-- Project Details Starts -->
                        <div class="col s12 l6 xl6 section-padding">
                            <h3 class="font-weight-700 uppercase">Paigham TV Pashto</h3>
                            <ul class="project-details second-font">
                ...
                <div data-panel="panel-4">
                    <div class="row">
                        ...
                        <!-- Project Details Starts -->
                        <div class="col s12 l6 xl6 section-padding">
                            <h3 class="font-weight-700 uppercase">RaheJannath</h3>
                            <ul class="project-details second-font">
                ...
                <div data-panel="panel-5">
                    <div class="row">
                        ...
                        <!-- Project Details Starts -->
                        <div class="col s12 l6 xl6 section-padding">
                            <h3 class="font-weight-700 uppercase">Schoolit System</h3>
                            <ul class="project-details second-font">
                ...
                <div data-panel="panel-6">
                    <div class="row">
                        ...
                        <!-- Project Details Starts -->
                        <div class="col s12 l6 xl6 section-padding">
                            <h3 class="font-weight-700 uppercase">Larkhud</h3>
                            <ul class="project-details second-font">
